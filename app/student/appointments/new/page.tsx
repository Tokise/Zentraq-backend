...
import { CalendarDays, Clock, FileText, Loader2, ArrowLeft } from "lucide-react"
...
export default function StudentNewAppointmentPage() {
        ...
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="reason"
                placeholder="e.g. Fever and Headache, Routine Medical Clearance, Dental Checkup"
                value={reason}
            ...
            <div className="space-y-2">
              ...
              <textarea
                id="symptoms"
                rows={3}
                placeholder="Describe any specific symptoms, duration, or special requests..."
                value={symptoms}
