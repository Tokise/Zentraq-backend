...
import { History, CalendarDays, Clock, FileText } from "lucide-react"
import { toast } from "sonner"

export default function StudentAppointmentHistoryPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto mt-[-25px] px-4 py-4">
      <PageHeader
        ...
        description="View records of your completed, cancelled, or past clinic appointments."
      />
