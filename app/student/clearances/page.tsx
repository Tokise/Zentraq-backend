...
import { FileCheck, FileText, Plus, Clock, CheckCircle2, AlertCircle } from "lucide-react"
import { toast } from "sonner"
import Link from "next/link"

export default function StudentClearancesPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto mt-[-25px] px-4 py-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <PageHeader
          title="My Clearances"
          description="Track your medical health clearance applications and status."
        />
        <Link href="/student/clearances/request">
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="py-14 px-6 text-center space-y-2">
              ...
              <p className="text-xs text-zinc-400">Request a health clearance for graduation, enrollment, or athletic activities.</p>
              <div className="pt-2">
                <Link href="/student/clearances/request">
                ...
                <div key={c.id} className="p-4 sm:p-5 hover:bg-zinc-50/60 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-zinc-900 text-sm">{c.purpose || "Health Clearance Request"}</span>
