...
export default function AdminMedicineDispensePage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Fulfill pending prescriptions from the pharmacy."
      />
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="py-16 text-center">
              ...
              <p className="text-sm text-muted-foreground">No pending prescriptions to dispense.</p>
            </div>
          ) : (
                ...
                <tbody className="divide-y">
                  {prescriptions.map((p) => (
                    <tr key={p.id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-4 py-3 text-zinc-600">{p.quantity ?? "—"}</td>
