...
import { getIncidentDetailAction, scheduleIncidentFollowUp } from "@/actions/admin/incidents-admin"
...
export default function AdminIncidentReferralPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Incident Referrals"
        description="Schedule follow-up care and referrals for incident cases."
      />
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="py-16 text-center">
              ...
              <p className="text-sm text-muted-foreground">No active incidents to refer.</p>
            </div>
          ) : (
                ...
                <tbody className="divide-y">
                  {incidents.map((inc) => (
                    <tr key={inc.id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-4 py-3 text-zinc-600 capitalize">{inc.status}</td>
