...
import { getIncidentDetailAction, logIncidentResponse, closeIncident } from "@/actions/admin/incidents-admin"
...
export default function AdminIncidentLogPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Incident Log"
        description="All incident cases recorded in the clinic."
      />
          ...
          {selected && (
            <div className="space-y-4">
              <div className="rounded-lg border border-zinc-200 p-4 space-y-2">
                ...
                <p className="text-xs text-zinc-500 capitalize">Type: {selected.incident_type}</p>
              </div>
                  ...
                  {selected.responses.map((r: any) => (
                    <div key={r.id} className="rounded-lg bg-zinc-50 p-3">
                      ...
                      <p className="text-xs text-zinc-400 mt-1">
                        {new Date(r.response_time).toLocaleString("en-US", { month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" })}
                      </p>
                    </div>
                  ))}
                </div>
          ...
          <DialogFooter className="gap-2">
            ...
            {selected?.status !== "closed" && (
              <>
                ...
                <Button onClick={handleLogResponse} disabled={processing || !responseText.trim()}>
