...
const RESCHEDULABLE = ["scheduled", "reminded", "approved", "recommended"]

export default function AdminAppointmentReschedulePage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (res.error) {
        ...
        setAppointments(res.appointments.filter((a) => RESCHEDULABLE.includes(a.status)))
      }
    } catch (err: any) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Change the date and time of scheduled appointments."
      />
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="py-16 text-center">
              ...
              <p className="text-sm text-muted-foreground">No reschedulable appointments found.</p>
            </div>
          ) : (
