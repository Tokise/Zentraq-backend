...
export default function FacultyVisitHistoryPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="My Visit History" description="Your recent consultations." />
                ...
                <tbody className="divide-y">
                  {consultations.map((c) => (
                    <tr key={c.id} className="hover:bg-zinc-50/50">
                      ...
                      <td className="px-4 py-3 max-w-[300px] truncate">{c.complaint || "—"}</td>
