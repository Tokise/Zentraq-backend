...
export default function FacultyPrescriptionsPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto mt-[-25px] px-4 py-4">
      <PageHeader
        title="Faculty Prescriptions"
        description="View prescribed medications and dosage instructions issued by clinic doctors."
      />
      ...
      <Card className="border-zinc-200/80 shadow-sm bg-white overflow-hidden">
        <CardHeader className="border-b border-zinc-100 pb-4">
          ...
          <CardDescription>
            Medication details, dosage instructions, and schedules.
          </CardDescription>
        </CardHeader>
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="py-14 px-6 text-center space-y-2">
              ...
              <p className="text-xs text-zinc-400">Prescribed medicines from clinic consultations will appear here.</p>
            </div>
          ) : (
