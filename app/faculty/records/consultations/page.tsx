...
export default function FacultyConsultationsPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto mt-[-25px] px-4 py-4">
      <PageHeader
        ...
        description="View your consultation records, physician notes, and recorded conditions."
      />
      ...
      <Card className="border-zinc-200/80 shadow-sm bg-white overflow-hidden">
        <CardHeader className="border-b border-zinc-100 pb-4">
          ...
          <CardDescription>
            Diagnoses and medical history recorded during clinic visits.
          </CardDescription>
        </CardHeader>
