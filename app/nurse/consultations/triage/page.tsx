...
export default function NurseConsultationsTriagePage() {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto mt-[-25px] px-4 py-4">
      <PageHeader
        title="Triage Queue"
        description="Manage patient triage and assessment."
      />
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="py-14 px-6 text-center space-y-1.5">
              ...
              <p className="text-sm font-medium text-zinc-600">No patients in triage</p>
              <p className="text-xs text-zinc-400">Patients will appear here after check-in.</p>
            </div>
          ) : (
            <>
              <Table>
