...
export default function NursePatientsFacultyPage() {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto mt-[-25px] px-4 py-4">
      <PageHeader
        ...
        description="View and manage faculty medical records."
      />
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="py-14 px-6 text-center space-y-1.5">
              ...
              <p className="text-sm font-medium text-zinc-600">No faculty found</p>
              <p className="text-xs text-zinc-400">Registered faculty will show up here.</p>
            </div>
          ) : (
            <>
              <Table>
                ...
                <TableBody>
                  {paginated.map((p) => (
                    <TableRow
                      ...
                      onClick={() => router.push(`/nurse/patients/${p.patient_id}?type=faculty`)}
                    >
                      <TableCell>
