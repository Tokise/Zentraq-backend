...
export default function NurseRfidKioskPage() {
  ...
  return (
    <div className="w-full flex justify-center px-4 pt-6 pb-10">
      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-5">
        {/* LEFT: Scan panel */}
        <div className="rounded-2xl border border-border shadow-lg bg-card p-8 flex flex-col items-center justify-center text-center gap-6 min-h-[400px]">
        ...
        {/* RIGHT: Result panel */}
        <div className="rounded-2xl border border-border shadow-lg bg-card p-8 flex flex-col min-h-[400px]">
          {!profile ? (
            ...
            <div className="result-enter flex flex-col h-full">
              ...
              <div className="space-y-1.5 flex-1">
                <button
                  type="button"
                  className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-blue-500/10 transition-colors cursor-pointer text-left"
                  onClick={() => {
                ...
                <button
                  type="button"
                  className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-emerald-500/10 transition-colors cursor-pointer text-left"
                  onClick={() => {
                ...
                <button
                  type="button"
                  className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-purple-500/10 transition-colors cursor-pointer text-left"
                  onClick={() => {
                    router.push(`/nurse/records/view?id=${profile.id}&type=${patientType}`)
                    resetScanner()
                  }}
                >
              ...
              <Button variant="ghost" size="sm" onClick={resetScanner} className="w-full cursor-pointer gap-1.5 mt-3">
