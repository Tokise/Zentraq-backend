...
export default function NurseMedicineRestockPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Restock Medicines" description="Medicines that need to be restocked." />
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="py-16 text-center">
              ...
              <p className="text-sm text-muted-foreground">No medicines need restocking.</p>
            </div>
          ) : (
