...
import { createOperator } from "@/app/(dashboard)/admin/clinic-accounts/actions"
...
export default function CreateClinicAccountPage() {
    ...
    async function handleCreate() {
        ...
        if (result.error) {
            ...
            router.push("/admin/clinic-accounts")
        }
    }
    ...
    return (
        <div className="mx-auto max-w-lg space-y-6">
            <PageHeader
                ...
                description="Set up a new dashboard login account for clinic staff."
            />
