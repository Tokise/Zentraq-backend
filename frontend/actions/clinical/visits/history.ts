...
export async function getClinicalVisitHistoryAction(): Promise<{
  error: string | null
  ...
  return fetchCachedVisitHistory(actor.id, actor.role, account.id)
}
...
function fetchCachedVisitHistory(
  ...
  return unstable_cache(
    ...
    [`visit-history-${actorId}-${actorRole}`],
